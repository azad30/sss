        ...
        <div class='demo'>\
            ...
            <form >\
                ...
                <div class='images boxed-patterns'>\
                    <a id='bg_p1' href='#'><img alt='' src='{{ url('design/assets/img/bg/bg_p1.jpg') }}' height='25' width='25'></a>\
                    <a id='bg_p2' href='#'><img alt='' src='{{ url('design/assets/img/bg/bg_p2.jpg') }}' height='25' width='25'></a>\
                    <a id='bg_p3' href='#'><img alt='' src='{{ url('design/assets/img/bg/bg_p3.jpg') }}' height='25' width='25'></a>\
                    <a id='bg_p4' href='#'><img alt='' src='{{ url('design/assets/img/bg/bg_p4.jpg') }}' height='25' width='25'></a>\
                    <a id='bg_p5' href='#'><img alt='' src='{{ url('design/assets/img/bg/bg_p5.jpg') }}' height='25' width='25'></a>\
                    <a id='bg_p6' href='#'><img alt='' src='{{ url('design/assets/img/bg/bg_p6.jpg') }}' height='25' width='25'></a>\
                    <a id='bg_p7' href='#'><img alt='' src='{{ url('design/assets/img/bg/bg_p7.jpg') }}' height='25' width='25'></a>\
                </div>   \
                <legend class='no-padding'>Skins</legend>\
                <div class='images boxed-skins'>\
                    <a id='bg_style_1' href='#'><img alt='' src='{{ url('design/assets/img/skin/skin-1.png') }}' height='24' width='25'></a>\
                    <a id='bg_style_2' href='#'><img alt='' src='{{ url('design/assets/img/skin/skin-2.png') }}' height='24' width='25'></a>\
                    <a id='bg_style_3' href='#'><img alt='' src='{{ url('design/assets/img/skin/skin-3.png') }}' height='24' width='25'></a>\
                </div>\
            </form>\
        </div>";
$(function(){
